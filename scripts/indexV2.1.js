...
function GamStrt() {
    var num = gmnm % 4;
    var dec = document.getElementById("dec" + gmnm+"x").value;
    var bid = document.getElementById("bid" + gmnm+"x").value;
    var suit = document.getElementById("suit" + gmnm+"x").value;
    var dbl = document.getElementById("dbl" + gmnm+"x").value;
    var vulloc=vul[num];
...
function GamEnd(){
    ...
    var bid = document.getElementById("bid"+gmnm+"x");
    var suit = document.getElementById("suit"+gmnm+"x");
    var dbl = document.getElementById("dbl"+gmnm+"x");
    var made = document.getElementById("made"+gmnm+"x");
...
function GamScrVul(){
    ...
    var bid = document.getElementById("bid"+gmnm+"x").value;
    var dbl = document.getElementById("dbl" + gmnm+"x").value;
    var made = document.getElementById("made"+gmnm+"x").value;
    var over = (made-6-bid);
    if (dbl=="") {
      if (over>=0) {
      var winr="N/S";
    ...
    document.getElementById("scr"+gmnm+"x").innerHTML = scr+"  "+winr;
     if (winr=="N/S") {
